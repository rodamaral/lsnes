...
namespace
{
	...
	keyboard::invbind imhold1(lsnes_instance.mapper, "+hold-macro", "Macro‣Hold all macros");
	keyboard::invbind imhold2(lsnes_instance.mapper, "hold-macro", "Macro‣Hold all macros (typed)");
	keyboard::invbind ipause_emulator(lsnes_instance.mapper, "pause-emulator", "Speed‣(Un)pause");
	keyboard::invbind ijback(lsnes_instance.mapper, "cycle-jukebox-backward", "Slot select‣Cycle backwards");
	keyboard::invbind ijforward(lsnes_instance.mapper, "cycle-jukebox-forward", "Slot select‣Cycle forwards");
	keyboard::invbind iloadj(lsnes_instance.mapper, "load-jukebox", "Load‣Selected slot");
	keyboard::invbind iloadjrw(lsnes_instance.mapper, "load-jukebox-readwrite",
		"Load‣Selected slot (readwrite mode)");
	keyboard::invbind iloadjro(lsnes_instance.mapper, "load-jukebox-readonly",
		"Load‣Selected slot (readonly mode)");
	keyboard::invbind iloadjp(lsnes_instance.mapper, "load-jukebox-preserve",
		"Load‣Selected slot (preserve input)");
	keyboard::invbind iloadjm(lsnes_instance.mapper, "load-jukebox-movie", "Load‣Selected slot (as movie)");
	keyboard::invbind isavej(lsnes_instance.mapper, "save-jukebox", "Save‣Selected slot");
	keyboard::invbind iadvframe(lsnes_instance.mapper, "+advance-frame", "Speed‣Advance frame");
	keyboard::invbind iadvsubframe(lsnes_instance.mapper, "+advance-poll", "Speed‣Advance subframe");
	keyboard::invbind iskiplag(lsnes_instance.mapper, "advance-skiplag", "Speed‣Advance poll");
	keyboard::invbind ireset(lsnes_instance.mapper, "reset", "System‣Reset");
	keyboard::invbind iset_rwmode(lsnes_instance.mapper, "set-rwmode", "Movie‣Switch to read/write");
	keyboard::invbind itoggle_romode(lsnes_instance.mapper, "set-romode", "Movie‣Switch to read-only");
	keyboard::invbind itoggle_rwmode(lsnes_instance.mapper, "toggle-rwmode", "Movie‣Toggle read-only");
	keyboard::invbind irepaint(lsnes_instance.mapper, "repaint", "System‣Repaint screen");
	keyboard::invbind itogglepause(lsnes_instance.mapper, "toggle-pause-on-end", "Movie‣Toggle pause-on-end");
	keyboard::invbind irewind_movie(lsnes_instance.mapper, "rewind-movie", "Movie‣Rewind movie");
	keyboard::invbind icancel_saves(lsnes_instance.mapper, "cancel-saves", "Save‣Cancel pending saves");
	keyboard::invbind iload1(lsnes_instance.mapper, "load $SLOT:1", "Load‣Slot 1");
	keyboard::invbind iload2(lsnes_instance.mapper, "load $SLOT:2", "Load‣Slot 2");
	keyboard::invbind iload3(lsnes_instance.mapper, "load $SLOT:3", "Load‣Slot 3");
	keyboard::invbind iload4(lsnes_instance.mapper, "load $SLOT:4", "Load‣Slot 4");
	keyboard::invbind iload5(lsnes_instance.mapper, "load $SLOT:5", "Load‣Slot 5");
	keyboard::invbind iload6(lsnes_instance.mapper, "load $SLOT:6", "Load‣Slot 6");
	keyboard::invbind iload7(lsnes_instance.mapper, "load $SLOT:7", "Load‣Slot 7");
	keyboard::invbind iload8(lsnes_instance.mapper, "load $SLOT:8", "Load‣Slot 8");
	keyboard::invbind iload9(lsnes_instance.mapper, "load $SLOT:9", "Load‣Slot 9");
	keyboard::invbind iload10(lsnes_instance.mapper, "load $SLOT:10", "Load‣Slot 10");
	keyboard::invbind iload11(lsnes_instance.mapper, "load $SLOT:11", "Load‣Slot 11");
	keyboard::invbind iload12(lsnes_instance.mapper, "load $SLOT:12", "Load‣Slot 12");
	keyboard::invbind iload13(lsnes_instance.mapper, "load $SLOT:13", "Load‣Slot 13");
	keyboard::invbind iload14(lsnes_instance.mapper, "load $SLOT:14", "Load‣Slot 14");
	keyboard::invbind iload15(lsnes_instance.mapper, "load $SLOT:15", "Load‣Slot 15");
	keyboard::invbind iload16(lsnes_instance.mapper, "load $SLOT:16", "Load‣Slot 16");
	keyboard::invbind iload17(lsnes_instance.mapper, "load $SLOT:17", "Load‣Slot 17");
	keyboard::invbind iload18(lsnes_instance.mapper, "load $SLOT:18", "Load‣Slot 18");
	keyboard::invbind iload19(lsnes_instance.mapper, "load $SLOT:19", "Load‣Slot 19");
	keyboard::invbind iload20(lsnes_instance.mapper, "load $SLOT:20", "Load‣Slot 20");
	keyboard::invbind iload21(lsnes_instance.mapper, "load $SLOT:21", "Load‣Slot 21");
	keyboard::invbind iload22(lsnes_instance.mapper, "load $SLOT:22", "Load‣Slot 22");
	keyboard::invbind iload23(lsnes_instance.mapper, "load $SLOT:23", "Load‣Slot 23");
	keyboard::invbind iload24(lsnes_instance.mapper, "load $SLOT:24", "Load‣Slot 24");
	keyboard::invbind iload25(lsnes_instance.mapper, "load $SLOT:25", "Load‣Slot 25");
	keyboard::invbind iload26(lsnes_instance.mapper, "load $SLOT:26", "Load‣Slot 26");
	keyboard::invbind iload27(lsnes_instance.mapper, "load $SLOT:27", "Load‣Slot 27");
	keyboard::invbind iload28(lsnes_instance.mapper, "load $SLOT:28", "Load‣Slot 28");
	keyboard::invbind iload29(lsnes_instance.mapper, "load $SLOT:29", "Load‣Slot 29");
	keyboard::invbind iload30(lsnes_instance.mapper, "load $SLOT:30", "Load‣Slot 30");
	keyboard::invbind iload31(lsnes_instance.mapper, "load $SLOT:31", "Load‣Slot 31");
	keyboard::invbind iload32(lsnes_instance.mapper, "load $SLOT:32", "Load‣Slot 32");
	keyboard::invbind isave1(lsnes_instance.mapper, "save-state $SLOT:1", "Save‣Slot 1");
	keyboard::invbind isave2(lsnes_instance.mapper, "save-state $SLOT:2", "Save‣Slot 2");
	keyboard::invbind isave3(lsnes_instance.mapper, "save-state $SLOT:3", "Save‣Slot 3");
	keyboard::invbind isave4(lsnes_instance.mapper, "save-state $SLOT:4", "Save‣Slot 4");
	keyboard::invbind isave5(lsnes_instance.mapper, "save-state $SLOT:5", "Save‣Slot 5");
	keyboard::invbind isave6(lsnes_instance.mapper, "save-state $SLOT:6", "Save‣Slot 6");
	keyboard::invbind isave7(lsnes_instance.mapper, "save-state $SLOT:7", "Save‣Slot 7");
	keyboard::invbind isave8(lsnes_instance.mapper, "save-state $SLOT:8", "Save‣Slot 8");
	keyboard::invbind isave9(lsnes_instance.mapper, "save-state $SLOT:9", "Save‣Slot 9");
	keyboard::invbind isave10(lsnes_instance.mapper, "save-state $SLOT:10", "Save‣Slot 10");
	keyboard::invbind isave11(lsnes_instance.mapper, "save-state $SLOT:11", "Save‣Slot 11");
	keyboard::invbind isave12(lsnes_instance.mapper, "save-state $SLOT:12", "Save‣Slot 12");
	keyboard::invbind isave13(lsnes_instance.mapper, "save-state $SLOT:13", "Save‣Slot 13");
	keyboard::invbind isave14(lsnes_instance.mapper, "save-state $SLOT:14", "Save‣Slot 14");
	keyboard::invbind isave15(lsnes_instance.mapper, "save-state $SLOT:15", "Save‣Slot 15");
	keyboard::invbind isave16(lsnes_instance.mapper, "save-state $SLOT:16", "Save‣Slot 16");
	keyboard::invbind isave17(lsnes_instance.mapper, "save-state $SLOT:17", "Save‣Slot 17");
	keyboard::invbind isave18(lsnes_instance.mapper, "save-state $SLOT:18", "Save‣Slot 18");
	keyboard::invbind isave19(lsnes_instance.mapper, "save-state $SLOT:19", "Save‣Slot 19");
	keyboard::invbind isave20(lsnes_instance.mapper, "save-state $SLOT:20", "Save‣Slot 20");
	keyboard::invbind isave21(lsnes_instance.mapper, "save-state $SLOT:21", "Save‣Slot 21");
	keyboard::invbind isave22(lsnes_instance.mapper, "save-state $SLOT:22", "Save‣Slot 22");
	keyboard::invbind isave23(lsnes_instance.mapper, "save-state $SLOT:23", "Save‣Slot 23");
	keyboard::invbind isave24(lsnes_instance.mapper, "save-state $SLOT:24", "Save‣Slot 24");
	keyboard::invbind isave25(lsnes_instance.mapper, "save-state $SLOT:25", "Save‣Slot 25");
	keyboard::invbind isave26(lsnes_instance.mapper, "save-state $SLOT:26", "Save‣Slot 26");
	keyboard::invbind isave27(lsnes_instance.mapper, "save-state $SLOT:27", "Save‣Slot 27");
	keyboard::invbind isave28(lsnes_instance.mapper, "save-state $SLOT:28", "Save‣Slot 28");
	keyboard::invbind isave29(lsnes_instance.mapper, "save-state $SLOT:29", "Save‣Slot 29");
	keyboard::invbind isave30(lsnes_instance.mapper, "save-state $SLOT:30", "Save‣Slot 30");
	keyboard::invbind isave31(lsnes_instance.mapper, "save-state $SLOT:31", "Save‣Slot 31");
	keyboard::invbind isave32(lsnes_instance.mapper, "save-state $SLOT:32", "Save‣Slot 32");
	keyboard::invbind islot1(lsnes_instance.mapper, "set-jukebox-slot 1", "Slot select‣Slot 1");
	keyboard::invbind islot2(lsnes_instance.mapper, "set-jukebox-slot 2", "Slot select‣Slot 2");
	keyboard::invbind islot3(lsnes_instance.mapper, "set-jukebox-slot 3", "Slot select‣Slot 3");
	keyboard::invbind islot4(lsnes_instance.mapper, "set-jukebox-slot 4", "Slot select‣Slot 4");
	keyboard::invbind islot5(lsnes_instance.mapper, "set-jukebox-slot 5", "Slot select‣Slot 5");
	keyboard::invbind islot6(lsnes_instance.mapper, "set-jukebox-slot 6", "Slot select‣Slot 6");
	keyboard::invbind islot7(lsnes_instance.mapper, "set-jukebox-slot 7", "Slot select‣Slot 7");
	keyboard::invbind islot8(lsnes_instance.mapper, "set-jukebox-slot 8", "Slot select‣Slot 8");
	keyboard::invbind islot9(lsnes_instance.mapper, "set-jukebox-slot 9", "Slot select‣Slot 9");
	keyboard::invbind islot10(lsnes_instance.mapper, "set-jukebox-slot 10", "Slot select‣Slot 10");
	keyboard::invbind islot11(lsnes_instance.mapper, "set-jukebox-slot 11", "Slot select‣Slot 11");
	keyboard::invbind islot12(lsnes_instance.mapper, "set-jukebox-slot 12", "Slot select‣Slot 12");
	keyboard::invbind islot13(lsnes_instance.mapper, "set-jukebox-slot 13", "Slot select‣Slot 13");
	keyboard::invbind islot14(lsnes_instance.mapper, "set-jukebox-slot 14", "Slot select‣Slot 14");
	keyboard::invbind islot15(lsnes_instance.mapper, "set-jukebox-slot 15", "Slot select‣Slot 15");
	keyboard::invbind islot16(lsnes_instance.mapper, "set-jukebox-slot 16", "Slot select‣Slot 16");
	keyboard::invbind islot17(lsnes_instance.mapper, "set-jukebox-slot 17", "Slot select‣Slot 17");
	keyboard::invbind islot18(lsnes_instance.mapper, "set-jukebox-slot 18", "Slot select‣Slot 18");
	keyboard::invbind islot19(lsnes_instance.mapper, "set-jukebox-slot 19", "Slot select‣Slot 19");
	keyboard::invbind islot20(lsnes_instance.mapper, "set-jukebox-slot 20", "Slot select‣Slot 20");
	keyboard::invbind islot21(lsnes_instance.mapper, "set-jukebox-slot 21", "Slot select‣Slot 21");
	keyboard::invbind islot22(lsnes_instance.mapper, "set-jukebox-slot 22", "Slot select‣Slot 22");
	keyboard::invbind islot23(lsnes_instance.mapper, "set-jukebox-slot 23", "Slot select‣Slot 23");
	keyboard::invbind islot24(lsnes_instance.mapper, "set-jukebox-slot 24", "Slot select‣Slot 24");
	keyboard::invbind islot25(lsnes_instance.mapper, "set-jukebox-slot 25", "Slot select‣Slot 25");
	keyboard::invbind islot26(lsnes_instance.mapper, "set-jukebox-slot 26", "Slot select‣Slot 26");
	keyboard::invbind islot27(lsnes_instance.mapper, "set-jukebox-slot 27", "Slot select‣Slot 27");
	keyboard::invbind islot28(lsnes_instance.mapper, "set-jukebox-slot 28", "Slot select‣Slot 28");
	keyboard::invbind islot29(lsnes_instance.mapper, "set-jukebox-slot 29", "Slot select‣Slot 29");
	keyboard::invbind islot30(lsnes_instance.mapper, "set-jukebox-slot 30", "Slot select‣Slot 30");
	keyboard::invbind islot31(lsnes_instance.mapper, "set-jukebox-slot 31", "Slot select‣Slot 31");
	keyboard::invbind islot32(lsnes_instance.mapper, "set-jukebox-slot 32", "Slot select‣Slot 32");
