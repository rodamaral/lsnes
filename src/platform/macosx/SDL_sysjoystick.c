...
/* Modified 2013-07-04 by H. Ilari Liusvaara:
- Change user includes to point to one file in the same directory.
- Change one non-ASCII character to be UTF-8 -compatible.
*/
