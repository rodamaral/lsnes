...
namespace sky
{
	...
	port_controller_button A9 = {port_controller_button::TYPE_NULL, '\0', "", false};
	port_controller_button A10 = {port_controller_button::TYPE_NULL, '\0', "", false};
	port_controller_button A11 = {port_controller_button::TYPE_BUTTON, 's', "select", false};
	port_controller_button A12 = {port_controller_button::TYPE_BUTTON, 'S', "start", false};
	port_controller_button A13 = {port_controller_button::TYPE_BUTTON, 'A', "up", false};
	port_controller_button A14 = {port_controller_button::TYPE_BUTTON, 'D', "down", false};
	port_controller_button A15 = {port_controller_button::TYPE_BUTTON, 'L', "left", false};
	port_controller_button A16 = {port_controller_button::TYPE_BUTTON, 'R', "right", false};
	port_controller_button A17 = {port_controller_button::TYPE_BUTTON, 'J', "A", false};
	port_controller_button* A7[] = {&A9,&A10,&A11,&A12,&A13,&A14,&A15,&A16,&A17};

	port_controller_button B9 = {port_controller_button::TYPE_BUTTON, 'J', "A", false};
	port_controller_button B10 = {port_controller_button::TYPE_NULL, '\0', "", false};
	port_controller_button B11 = {port_controller_button::TYPE_BUTTON, 's', "select", false};
	port_controller_button B12 = {port_controller_button::TYPE_BUTTON, 'S', "start", false};
	port_controller_button B13 = {port_controller_button::TYPE_BUTTON, 'R', "right", false};
	port_controller_button B14 = {port_controller_button::TYPE_BUTTON, 'L', "left", false};
	port_controller_button B15 = {port_controller_button::TYPE_BUTTON, 'A', "up", false};
	port_controller_button B16 = {port_controller_button::TYPE_BUTTON, 'D', "down", false};
	port_controller_button B17 = {port_controller_button::TYPE_NULL, '\0', "", false};
